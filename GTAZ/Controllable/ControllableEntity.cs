...
namespace GTAZ.Controllable {
    ...
    public abstract class ControllableEntity : Updater {
        ...
        protected event ChangedEventHandler AirEnter, WaterEnter, UpsideDown, Attached, TouchPlayer, PlayerNearby, PlayerNotNearby, Dead, Initialize, Alive;
        ...
        protected ControllableEntity(string groupId) {
            GroupId = groupId;
        }
        ...
        private int _playerNearbyTicks, _playerNotNearbyTicks, _pedNearbyTicks, _playerTouchingTicks, _entityIsAttachedTicks,
        ...
        protected override void OnActiveUpdate(int activeTick, int tick) {
            ...
            if (Entity.IsAlive) {
                ...
                if (!Entity.IsInRangeOf(Main.Player.Character.Position, _interactionDistance)) {
                    ...
                    if (_playerNotNearbyTicks == 0) {
                        if (PlayerNotNearby != null)
                            PlayerNotNearby(this, EventArgs.Empty);
                    }

                    _playerNotNearbyTicks++;

                } else {

                    _playerNotNearbyTicks = 0;
        ...
        public void RemoveEntity() {
            ...
            Main.ControlManager.Remove(UniqueId);
