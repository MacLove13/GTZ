...
namespace GTAV_purge_mod {
    ...
    public abstract class Updater {
        ...
        /// <param name="tick">The total amount of ticks.</param>
        protected virtual void OnInactiveUpdate(int inactiveTick, int tick) {}

        /// <summary>
        /// Fired the first time an active update has been made.
        /// </summary>
        /// <param name="tick">The total amount of ticks.</param>
        protected virtual void OnFirstActiveUpdate(int tick) {}

        /// <summary>
        /// Fired the first time an inactive update has been made.
        /// </summary>
        /// <param name="tick">The total amount of ticks.</param>
        protected virtual void OnFirstInactiveUpdate(int tick) {}
